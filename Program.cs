...
namespace linq
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var fourSixMultiples = numbers.Where(n => n % 6 == 0 || n % 4 == 0 );
            ...
            var descend = names.OrderByDescending(a=>a.ToList());

            foreach (var firstLetter in descend)
            {
            ...
            var ascend = numbersA.OrderBy(n => n);
            ...
            */
            ...
            foreach (var numb in wheresSquaredo)
            {
                double numb1 = Math.Sqrt(numb);
                bool isSquare = numb1 % 1 == 0;
                if (isSquare)
                {
            ...
            var group = customers.Where(c => c.Balance >= 1000000)
            .GroupBy(d => d.Bank, d => d.Name);

            foreach (var potato in group)
            {
